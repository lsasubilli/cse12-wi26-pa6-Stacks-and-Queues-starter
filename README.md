# CSE 12 PA6: Stacks and Queues with a Deque

There is an FAQ post on Piazza. **Due date: Thursday, February 19 @ 11:59 PM PST**
...
* Understand when to use Stacks and Queues
...
* **Task 1** [90 points] You will earn points based on the autograder tests that your code passes. If the autograder tests are not able to run (e.g., your code does not compile or it does not match the specifications in this writeup), you may not earn credit.
    ...
    * **Coding Style** [5 points]
        * `MyDeque.java`, `MyStack.java`, and `MyQueue.java` will be graded on style. `CustomTester.java` will be graded on file, class, method headers and indentation.
* **Task 2** [10 points]
    * Fill out **PA6 Task 2** on Gradescope.

**Note:** There is no `MyAlgorithm` for this PA.
...
## Task 1: Testing and Implementation of Deque, Stack, and Queue [90 points]
...
There will be a few scenario questions about when it is best to use either a Stack or Queue. Additonally, there are a couple questions comparing implementing Stacks and Queues with a Deque compared to an ArrayList.

Your task: Fill out PA6 Task 2 form on Gradescope. This will NOT be eligible for resubmission.
